...
public class CreateXML {
	...
	public void insertPhase(Project project, int i) throws XMLStreamException,NullPointerException {
		...
		eventWriter.add(end);
		createNode(eventWriter, "phaseName", project.getPhases().get(i).getPhaseName());
		createNode(eventWriter, "startDate", "" + project.getPhases().get(i).getStartDate());
		createNode(eventWriter, "endDate", "" + project.getPhases().get(i).getEndDate());
		createNode(eventWriter, "riskFactor", "" + project.getPhases().get(i).getRiskFactor());
		if (project.getPhases().get(i).getParent() != null) {
			createNode(eventWriter, "parent", project.getPhases().get(i).getParent().getPhaseName());		
		}
	...
	// Resourcenstag erstellen
		...
		public void insertResource(Project project, int i) throws XMLStreamException,NullPointerException {
			...
			eventWriter.add(end);
			createNode(eventWriter, "resourcename", project.getResources().get(i).getResourceName());
			createNode(eventWriter, "resourceID", "" + project.getResources().get(i).getResourceID());
			createNode(eventWriter, "skillID", "" + project.getResources().get(i).getSkillID());
			createNode(eventWriter, "availability", "" + project.getResources().get(i).getAvailability());
			createNode(eventWriter, "skillamount", "" + project.getResources().get(i).getSkillAmount());
			createNode(eventWriter, "intern", "" + project.getResources().get(i).isIntern());
